...
const styles = StyleSheet.create({
  ...
  chipText: { fontFamily: sg.font.bodyMedium, fontSize: 12, color: sg.muted },
  chipTextActive: { color: sg.goldHi, fontFamily: sg.font.bodyBold },
  ...
  featuredBody: { flex: 1 },
  featuredEyebrow: { fontFamily: sg.font.bodyMedium, fontSize: 11, color: sg.muted },
