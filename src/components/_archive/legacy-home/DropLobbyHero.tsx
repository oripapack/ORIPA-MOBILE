...
type Props = {
  pack: Pack;
  /** Switches home to browse mode (catalog floor). */
  onBrowseFloor?: () => void;
};
    ...
    <View style={styles.section}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.meta}>
          ...
          {onBrowseFloor ? (
            <Pressable onPress={onBrowseFloor} hitSlop={8} style={styles.floorLinkHit}>
              <Text style={styles.floorLink}>{t('home.lobby.enterFloor')}</Text>
            </Pressable>
          ) : null}
        </View>
      </View>
