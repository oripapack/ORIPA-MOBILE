...
export const CATALOG_PACKS: CatalogPack[] = [
  {
    ...
    tagline: 'Perfect first pull · Trade in at 100% of listed value, in Points',
    description: 'Designed for first-time collectors. Instant Trade in at 100% of listed value, in Points.',
