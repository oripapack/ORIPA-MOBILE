/**
 * 実データ待ち。外部に見せないこと。
 * Review-only feed placeholders; never use as production activity.
 */
...
export const MOCK_RECENT_PULLS: RecentPull[] = [
...
/** @deprecated Legacy prototype compatibility only. */
export { MOCK_RECENT_PULLS as RECENT_PULLS };
