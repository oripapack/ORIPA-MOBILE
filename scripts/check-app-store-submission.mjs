...
for (const approval of [
  ...
  'APP_STORE_APP_PRIVACY_COMPLETED',
  'APP_STORE_AGE_RATING_COMPLETED',
  'APP_STORE_CONNECT_METADATA_VERIFIED',
  'APP_STORE_SCREENSHOTS_VERIFIED',
  'APP_STORE_CONTENT_RIGHTS_APPROVED',
  'APP_STORE_EXPORT_COMPLIANCE_APPROVED',
  'APP_STORE_AGREEMENTS_TAX_BANKING_READY',
]) {
  requireYes(approval);
}
